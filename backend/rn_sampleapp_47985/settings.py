"""
Django settings for rn_sampleapp_47985 project.
...
ROOT_URLCONF = 'rn_sampleapp_47985.urls'
...
WSGI_APPLICATION = 'rn_sampleapp_47985.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rn_sampleapp_47985 API",
    "DESCRIPTION": "API documentation for rn_sampleapp_47985 App",
    "VERSION": "v1",
}
